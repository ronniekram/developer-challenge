...
export default function Cupcake({ children }) {
	return (
		<Wrapper>
			<ProductImage src={cupcakes}></ProductImage>
			<ProductName>Unicorn Sparkle Cupcakes</ProductName>
			<ProductDescription>
				Effervescent frosting imbued with tart unicorn tears
				and expired rainbows, piped delicately upon a
				delectable confectionary surprise!
			</ProductDescription>
